...
class TestCRUDMadum(unittest.TestCase):
    ...
    def test_remove_user_group_2(self):
        crud = CRUD()  
        crud.remove_user_group('0', "default")      
        crud.add_new_user("alex@gmail.com", "2021-02-09")    
        crud.remove_user(1)
    ...
    def test_remove_user_group_3(self):
        crud = CRUD()  
        crud.remove_user_group('0', 'default')
    ...
    def test_remove_user_group_5(self):
        crud = CRUD()  
        crud.remove_user_group('0', 'default')
        crud.update_users(0, "Trust", 50)   
        crud.remove_user(0) 
        user_data = crud.add_new_user("wow@gmail.com", "2021-02-09")    
        self.assertEqual(user_data, self.test_user)
