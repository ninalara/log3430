...
class TextCleaning:
    ...
    def clean_text(self, text, option):
        '''
        Description: fonction qui gere le nettoyage du texte selon le parametre entre
        si option = 0, stemming, no stopwords
        option = 1, no stemming, no stopwords
        option = 2, stemming, stopwords
